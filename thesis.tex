...
\item
Αν ένα όνομα ενός field βρεθεί μέσα σε μια έκφραση τιμής οι οποία είναι
υποέκφραση μίας έκφραφασης "\verb|.change|", τo όνομα μετατρέπεται σε μία
συνάρτηση επιθήματος οι οποία έχει το ίδιο όρισμα με την συνάρτηση
"\verb|.change|". Για παράδειγμα, αν ένα κομμάτι του συντακτικού δέντρου
αντιστοιχεί την παρακάτω έκφραση, θα μετατρεπεί σε αυτό που ακολουθεί:\\
...
το βέλος, αντικαθιστάται από την σύζευξη στην οποία αντιστοιχεί. Όλες
