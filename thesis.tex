...
είναι αληθής η ψευδής για κάθε συνδιασμό ορισμάτων.

Οι προτάσεις τύπων μπορούν είτε να οριστούν είτε να αποδειχτούν.
Οι έννοεις των \textbf{ορισμών προτάσεων τύπων} και \textbf{θεωρημάτων τύπων}
...
\end{verbatim}
Τα παραπάνω παραδείγματα ορίζουν τις παρακάτων ad hoc πολυμορφικές συναρτήσεις
...
τύπων. Για να προστεθούν περισσότεροι συνδιασμοί τύπων ορισμάτων για τους
...
την οποία ακολουθέι μία πρόταση ή πολλές προτάσεις χωρισμένες με κόμματα
...
Ένα θεώτημα ατομικής πρότασης αποδεικνύει την πρόταση για συγκεκριμένους
...
Ένα θεώρηματα πρότασης συνεπαγωγής είναι παρόμοιο με ένα θεώρημα ατομικής
...
\item
Στις εκφράσεις συνάρτησεων "cases" που δεν ξεκινούν στην γραμμή με το ίσον
ενός ορισμού τιμής:
  \begin{enumerate}
...
γραμματικές με συμφροζόμενα και άπειρο look-ahead. Τα καταφέρνει αυτά
...
\item
  \textit{user state type:} Τύπος κατάστασης που επιθημεί ο προγραμματιστής.
\item
  \textit{underlying monad type:}
  Επιπλέον εσωτερικός τύπος Monad αν χρειάζεται.
\item
  \textit{return type:} O τύπος του συντατικού δέντρου του αναλυτή.
\end{itemize}
...
αντιστιχούν σε μη-τερματικά σύμβολα και οι αναλυτές προσπαθούν να αναλύσουν την
...
συντατκτιού δέντρου στον οποίο αναλύει με τύπο εισόδου String και τύπο
...
συνδιαστούν με άλλους αναλυτές). Χρησιμοποιούνται όπως ορίζεται στον κανόνα 2
του Συστήματος Στοίχισης (\ref{sec:indsysgr}). Ο "\verb|has_type_symbol|"
αναλύει με το εξής κομμάτι του κανόνα:
( [ \lit{\ } ] \lit{:} [ \lit{\ } ] \verb||| \synt{nl}
\synt{indent} \lit{:\ }). Οι "\verb|we_are_in_equal_line|" και
